"""Vision dataset loading shared across the SNN pipeline."""
...
def load_dataset_by_name(
    ...
    """Load a vision dataset by name and return DatasetConfig."""
    ...
    ds = loader(root=root, train=train, download=True, transform=transform)
    img0, _ = ds[0]
